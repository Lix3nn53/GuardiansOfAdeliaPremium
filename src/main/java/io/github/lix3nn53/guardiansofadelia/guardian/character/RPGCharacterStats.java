...
/*    public void clearMainHandBonuses() {
    ...
    public void addToBuffMultiplier(BuffType buffType, float addToMultiplier, PotionEffect potionEffect) {
        ...
        } else if (buffType.equals(BuffType.ELEMENT_WATER)) {
            Element element = elementHashMap.get(ElementType.WATER);
            element.addToTotalBuff((int) addToMultiplier);
        } else if (buffType.equals(BuffType.ELEMENT_EARTH)) {
            Element element = elementHashMap.get(ElementType.EARTH);
            element.addToTotalBuff((int) addToMultiplier);
        } else if (buffType.equals(BuffType.ELEMENT_LIGHTNING)) {
            Element element = elementHashMap.get(ElementType.LIGHTNING);
            element.addToTotalBuff((int) addToMultiplier);
        } else if (buffType.equals(BuffType.ELEMENT_AIR)) {
            Element element = elementHashMap.get(ElementType.AIR);
            element.addToTotalBuff((int) addToMultiplier);
        }
