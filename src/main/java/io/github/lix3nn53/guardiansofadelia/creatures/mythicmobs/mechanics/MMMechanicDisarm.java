...
public class MMMechanicDisarm extends SkillMechanic implements ITargetedEntitySkill {

    protected final int duration;

    public MMMechanicDisarm(SkillExecutor skillManager, MythicLineConfig config) {
    ...
    public SkillResult castAtEntity(SkillMetadata data, AbstractEntity abstractEntity) {
        ...
        StatusEffectType effectType = StatusEffectType.DISARM;
