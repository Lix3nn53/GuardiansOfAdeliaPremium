...
public class MMMechanicRoot extends SkillMechanic implements ITargetedEntitySkill {

    protected final int duration;

    public MMMechanicRoot(SkillExecutor skillManager, MythicLineConfig config) {
    ...
    public SkillResult castAtEntity(SkillMetadata data, AbstractEntity abstractEntity) {
        ...
        StatusEffectType effectType = StatusEffectType.ROOT;
