...
public class GuardiansOfAdelia extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Bukkit.getPluginManager().registerEvents(new MyPlayerToggleSneakEvent(), this);
        ...
        this.getCommand("admininteractable").setExecutor(new CommandAdminInteractable());
        ...
        for (World w : Bukkit.getServer().getWorlds()) {
            ...
            w.setGameRule(GameRule.DO_WARDEN_SPAWNING, false); //DISABLED
            w.setTime(3000);
