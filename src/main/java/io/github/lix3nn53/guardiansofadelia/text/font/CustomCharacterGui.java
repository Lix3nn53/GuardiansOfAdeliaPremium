...
public final class CustomCharacterGui {

    public static final CustomCharacter MENU_54 = new CustomCharacter("MENU_54", '섃', 1, 82, ChatColor.WHITE, NegativeSpace.NEGATIVE_2, NegativeSpace.POSITIVE_4);
    public static final CustomCharacter MENU_54_FLAT = new CustomCharacter("MENU_54_FLAT", '섄', 3, 41, ChatColor.WHITE, NegativeSpace.NEGATIVE_4, NegativeSpace.POSITIVE_4);
