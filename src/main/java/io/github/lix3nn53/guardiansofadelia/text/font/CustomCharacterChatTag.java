...
public final class CustomCharacterChatTag {
    ...
    public static final CustomCharacter BUILDER = new CustomCharacter("CHAT_TAG_BUILDER", 'ꑫ', 0, 0, ChatColor.WHITE);
    public static final CustomCharacter ARTIST = new CustomCharacter("CHAT_TAG_ARTIST", 'ꑬ', 0, 0, ChatColor.WHITE);
