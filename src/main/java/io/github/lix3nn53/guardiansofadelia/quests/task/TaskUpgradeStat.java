...
public final class TaskUpgradeStat extends TaskBase {
    ...
    public String getTablistInfoString(String language) {
        ...
        return chatPalette + Translation.t(language, "quest.task.upgradeStat.l1");
    }
    ...
    public String getItemLoreString(GuardianData guardianData) {
        ...
        return color + Translation.t(guardianData, "quest.task.upgradeStat.l1");
    }
    ...
    public boolean progress(Player player, Attribute attr, int questID, int taskIndex, boolean ignorePrevent) {
